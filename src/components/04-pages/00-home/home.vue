...
<template>
  <div>
    ...
    <Banner url="@images/site/soap_banner.jpg">
      ...
      <H1 class="banner_title" text="Flash Sale!" />
...
<script>
  ...
  import PrimaryNavigation from      '../../03-templates/05-primary_navigation/primary_navigation.vue'
